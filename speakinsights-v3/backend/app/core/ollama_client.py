...
class OllamaClient:
    ...
    def __init__(self) -> None:
        ...
        # Ollama 0.19+ enforces Origin checks — set Origin to Ollama's own
        # URL so requests from Docker containers (host.docker.internal) pass.
    ...
    async def generate(
        ...
        for attempt in range(1, max_retries + 1):
            try:
                ...
                async with httpx.AsyncClient(timeout=300.0, headers=self._headers) as client:
